...
public class SizeAdapter_40 extends RecyclerView.Adapter<SizeAdapter_40.MySizeHolder> {

    private final ArrayList<Size_Model_40> size_modelArrayList;
    private final Context context;
    private int position;

    public SizeAdapter_40(Context context, ArrayList<Size_Model_40> size_modelArrayList) {
    ...
    public MySizeHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_size_40, viewGroup, false);
